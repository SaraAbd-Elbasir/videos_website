...
@section('content')
    ...
    @component('back-end.shared.edit' , ['pageTitle' => $pageTitle , 'pageDes' => $pageDes])
        ...
        @slot('md4')
            ...
            @if($url)
                <iframe width="250" height="250" src="https://www.youtube.com/embed/{{ $url }}" style="margin-bottom: 20px" frameborder="0"  allowfullscreen></iframe>
            @endif
            <img src="{{ url('uploads/'.$row->image) }}" width="250"  height="250" >
        @endslot
    @endcomponent
